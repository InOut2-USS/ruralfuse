...
<body style="height: 100%; width: 100%;">
	...
	<div style="display: flex; flex-direction: row; flex-wrap: wrap; justify-content: center; align-items: center; width: 100%; height: 100%;">
		<a href="{{ url('register/middleman') }}" class="btn btn-common">Representative Registratoin</a>
        <a href="{{ url('register/employer') }}" class="btn btn-common">Employer Registration</a>
	</div>
